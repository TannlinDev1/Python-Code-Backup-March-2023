...
# This script generates Aerotech code for a "W" stitch pattern but switches between sides every weld (reduces thermal distortion)
...
def GCode_Gen(points, N): #define G code generator function
    ...
    while I<N: #write G Code
        ...
        if J % 2 == 0:
            ...
            code[I, 0] = "G01 " + "X " + str(np.round(points[J_M,0],2)) + " Y " + str(np.round(points[J_M,1],2))
